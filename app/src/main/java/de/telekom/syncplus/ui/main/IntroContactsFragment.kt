...
import kotlinx.android.synthetic.main.fragment_intro_contacts.view.*

class IntroContactsFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_intro_contacts, container, false)
