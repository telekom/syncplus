...
import de.telekom.syncplus.databinding.FragmentIntroContactsBinding
import de.telekom.syncplus.util.viewbinding.viewBinding

class IntroContactsFragment : BaseFragment(R.layout.fragment_intro_contacts) {
    override val TAG: String
        get() = "INTRO_CONTACTS_FRAGMENT"
    ...
    private val binding by viewBinding(FragmentIntroContactsBinding::bind)
