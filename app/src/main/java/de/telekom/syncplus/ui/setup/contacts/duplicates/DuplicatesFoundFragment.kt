...
class DuplicatesFoundFragment : BaseFragment(R.layout.fragment_duplicates_found) {
    ...
    companion object {
        ...
        fun newInstance(accountName: String): DuplicatesFoundFragment {
            return DuplicatesFoundFragment().apply {
    ...
    override fun onViewCreated(
        ...
        binding.mergeButton.setOnClickListener {
            push(R.id.container, DuplicateProgressFragment.newInstance(accountName))
        }
        binding.doNotMergeButton.setOnClickListener {
            showSkipDialog(requireActivity()) {
                push(R.id.container, CopySuccessFragment.newInstance(accountName,false))
            }
        }
    }
