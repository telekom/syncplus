...
import kotlinx.android.synthetic.main.fragment_intro_calendar.view.*

class IntroCalendarFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_intro_calendar, container, false)
