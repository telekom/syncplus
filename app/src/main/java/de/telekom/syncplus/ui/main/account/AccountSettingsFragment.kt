...
import de.telekom.syncplus.ui.dialog.NetworkErrorDialog
import de.telekom.syncplus.ui.dialog.ServiceDiscoveryErrorDialog
import de.telekom.syncplus.ui.setup.calendar.CalendarCollectionsViewModel
...
class AccountSettingsFragment : BaseFragment(R.layout.fragment_accounts_settings) {
    ...
    private fun setupSyncDropdown(accountSettings: AccountSettings) {
        val syncInterval = accountSettings.tryGetSyncInterval()
        ...
        binding.moreSettingsButton.setOnClickListener {
            showSyncIntervalDialog(accountSettings.tryGetSyncInterval()) { interval ->
