...
import kotlinx.android.synthetic.main.fragment_intro_cloud.view.*

class IntroCloudFragment : BaseFragment() {
    override val TAG: String
        get() = "INTRO_CLOUD_FRAGMENT"

    companion object {
        private const val ARG_LISTENER = "ARG_LISTENER"
        private const val ARG_BOTTOM_PADDING = "ARG_BOTTOM_PADDING"
        fun newInstance(l: IntroActivity.OnCancelListener, bottomPadding: Int): IntroCloudFragment {
            val args = Bundle(2)
            args.putParcelable(ARG_LISTENER, l)
            args.putInt(ARG_BOTTOM_PADDING, bottomPadding)
            val fragment = IntroCloudFragment()
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_intro_cloud, container, false)
